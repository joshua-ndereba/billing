          ...
          child: Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: const Color.fromARGB(255, 123, 188, 20)
                    .withOpacity(0.9), // Card background color
                borderRadius: BorderRadius.circular(16.0),
                boxShadow: [
                  BoxShadow(
                    color:
                        const Color.fromARGB(255, 208, 37, 37).withOpacity(0.2),
                    blurRadius: 10,
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                icon: Icon(
                  _obscureText
                      ? Icons.visibility
                      : Icons.visibility_off, // Eye icon toggle
                ),
                onPressed: () {
                  setState(() {
            ...
            onPressed: () async {
              /*if (usernamecont.text.isEmpty) {
                ...
                final response = await http.get(Uri.parse(
                    "http://localhost/dashboard/hike/login.php?username=${usernamecont.text}&password=${passwordcont.text}"));
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      if (googleUser != null) {
        // Handle login successful logic here
        // For instance, navigate to the dashboard or store user information
        Get.toNamed('/dashboard');
      }
    } catch (error) {
      print(error);
